                      ...
                      <div class="col-md-4 p-1">
                        ...
                        <div class="row"  style="background-color: #f9f6f7; color: blue; padding-left: 5%;">
                          ...
                          <div class="row mt-3 justify-content-center">
                              <button class="btn btn-primary col-sm-11 ml-1" name="submit" type="submit" style=" padding: 3%;">PLACE ORDER</i></button>
                        </div>
                        </form>
                                ...
                                if (!empty($method)) {
                                    if ($method == 'COD') {
                                        if (isset($_REQUEST['medication_id'])) { 
                                              ...
                                              $query3="UPDATE medication SET payment='COD' WHERE medication_id='".$id."'";
                                              $sql3=mysqli_query($con,$query3);
                                              echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"mymedication.php\";</script>";

                                         }
                                    }else{
                                      echo "<script type=\"text/javascript\"> alert(\"This Payment Method Coming Soon. Please select onother Method\");</script>";
                                    }
                                }else{
